...
import com.tinyagenda.utils.AgendaMonth;
...
public class Month extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if( request.getParameter("loadmonth")!=null && request.getParameter("loadyear")!=null){
            iMonth=Integer.parseInt(request.getParameter("loadmonth").toString());
            year=Integer.parseInt(request.getParameter("loadyear").toString());
            month=new AgendaMonth(year, iMonth, usr);
        }else{
            month=new AgendaMonth(usr);
        }
        request.setAttribute("mymonth", month);
